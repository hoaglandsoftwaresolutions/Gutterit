      ...
      <div className="container pt-16 pb-10 md:pt-24 md:pb-12">
        <div className="grid gap-10 md:grid-cols-[1fr_2fr] md:gap-16">
          ...
          <div className="space-y-5 text-base leading-relaxed text-navy/80">
            ...
            <p>
              Whether you're dealing with overflowing gutters in a fall storm, a sagging downspout that's been dripping all summer, or you need a gutter repair before the next round of rain does more damage, we're the local crew you can actually count on. And if you're finally ready to put seamless aluminum on a home that's still running 1980s sectional gutters, we handle that too. Free on-site quotes, same-day callbacks, and most jobs scheduled within the week.
            </p>
            <p>
              Our work covers the full lifecycle of a gutter system — from a brand-new seamless installation formed on your driveway, to twice-a-year cleanings that keep leaves and debris from packing the downspouts, to gutter repair that catches sagging sections, leaky seams, and fascia rot before they spread. We also handle gutter guards, leaf protection, downspout extensions, splash blocks, and underground drainage runs that move water far enough from your foundation to actually do some good. If it has to do with how water gets off your roof and away from your house, it's what we do.
            </p>
          </div>
        </div>
