...
import { LOCAL_GUTTER_CLEANING_CHATTANOOGA as L } from "../data/localPages";

const HERO_IMAGE = "/images/jobs/cleaning/leavesingutter.jpg";

export default function GutterCleaningChattanooga() {
  return (
    <>
      <PageSeoTags path="/gutter-cleaning-chattanooga" />
      ...
      <section className="relative isolate overflow-hidden bg-navy">
        ...
        <div className="relative container py-16 md:py-24 lg:py-28">
          ...
          <h1 className="mt-3 max-w-3xl font-display text-3xl font-bold leading-tight text-white md:text-4xl lg:text-5xl drop-shadow-[0_2px_8px_rgba(15,41,66,0.35)] animate-fade-in">
            Gutter cleaning in Chattanooga, done by hand.
          </h1>
          <p className="mt-4 max-w-2xl text-base leading-relaxed text-cream/85 animate-fade-in-up md:text-lg">
            ...
            every downspout flushed, debris hauled away. We provide a quote before we start.
          </p>
      ...
      <section className="bg-white">
        <div className="container py-16 md:py-20">
          <div className="grid gap-10 md:grid-cols-[1fr_2fr] md:items-start md:gap-16">
            <div>
              <p className="eyebrow">Local to Chattanooga</p>
      ...
      <Testimonials
        heading="What Chattanooga homeowners said."
        eyebrow="Testimony"
      ...
      <Faq
        heading="Gutter cleaning questions, Chattanooga edition."
      ...
      <CtaSection
        ...
        heading="Get your free Chattanooga gutter cleaning quote."
