...
export const LOCAL_GUTTER_CLEANING_EAST_BRAINERD: LocalPageContent = {
  intro: {
    heading: "Why gutter cleaning matters in East Brainerd, TN.",
    body: [
      "East Brainerd is one of the fastest-growing corners of Chattanooga — subdivisions off East Brainerd Road, Standifer Gap, and out toward the Ooltewah and Collegedale line, tucked between mature hardwoods and the newer construction going up every year. That mix is exactly what fills gutters here: established streets shaded by big oaks and sweetgums, and newer homes that often went up with builder-grade gutters undersized for the roof above them.",
      "We're Gutter-It LLC, family-owned and based on Bass Road in Chattanooga — a short drive from East Brainerd, so it's an area we're in most weeks. When you call, you're talking to the people who'll actually be on your ladder, not a call center routing you to whoever's closest. That's the difference between a $79 'special' that blows debris into your beds and a real cleaning that flushes every downspout.",
      "Every visit ends with a straight walk-through: what we pulled out, what we saw up there, and whether anything needs a follow-up. If your East Brainerd gutters are fine, we'll tell you they're fine. If a downspout's clogged underground or a section is starting to sag, we'll show you and quote it separately — never tacked on without asking.",
    ],
  },
  signs: {
    heading: "Signs your East Brainerd gutters need cleaning.",
    items: [
      {
        title: "Water sheeting off the back edge in a storm",
        body: "During one of our afternoon downpours, if water curtains off the back of the gutter instead of running to the downspout, it's packed and overflowing against the fascia.",
      },
      {
        title: "Builder-grade gutters overflowing when clean",
        body: "A lot of newer East Brainerd construction has thin 5-inch gutters and too few downspouts. If they spill even after a cleaning, the system's undersized — we'll flag it honestly.",
      },
      {
        title: "Oak and sweetgum debris from the driveway",
        body: "The established East Brainerd streets are heavy with hardwoods. Leaves, seed pods, and gumballs mat into a layer water can't pass and downspouts can't move.",
      },
      {
        title: "Stained siding below the gutter line",
        body: "Vertical streaks under the gutter mean it's been overflowing. Left long enough, those stains need pressure washing to remove.",
      ...
      {
        title: "A silent downspout in a downpour",
        body: "If it's pouring and the downspout isn't gushing, it's clogged — and the water is running behind the gutter and down your wall instead.",
      },
      {
        title: "Seedlings or standing water in the trough",
        body: "Our humidity turns trapped debris into compost fast. Green growth or standing water means it's been holding a soil layer through more than one rain.",
      },
    ],
  },
  whatsIncluded: {
    heading: "What's included in an East Brainerd gutter cleaning.",
    items: [
      {
        title: "Hand-clearing, every section",
        body: "We scoop by hand from the ladder — leaves, pine straw, shingle grit, seed pods, the works. No leaf blower scattering it into your beds.",
      ...
      {
        title: "Free visual inspection",
        body: "While we're up there we check hangers, seams, fascia, and pitch — and tell you plainly if anything needs attention, including whether builder-grade gutters are undersized.",
      },
      {
        title: "Roof valleys cleared",
        body: "Debris that piles where two roof planes meet slides straight back into the gutter at the next rain. We clear those so the cleaning lasts.",
  ...
  process: {
    heading: "How an East Brainerd gutter cleaning visit runs.",
    steps: [
      {
        title: "Same-day callback",
        body: "Call or text and we get back to you the same day. Most on-site quotes happen within 2–4 business days; active leaks jump the line.",
  ...
  pricing: {
    headline: "What gutter cleaning costs in East Brainerd.",
    body: [
      "Single-story East Brainerd homes typically run $100–$175. Two-story homes — common in the newer subdivisions — are $150–$250 depending on roof line, linear footage, and how much debris has built up. Steep-roof and larger homes are quoted on-site.",
      "You get a firm number written on the receipt before we start. If we find a clogged underground downspout or a section that needs repair, we quote that separately — never tacked onto the cleaning total without asking you first.",
    ],
    bullets: [
      { label: "1 story, standard home", value: "$100–$175" },
      { label: "2 story, standard home", value: "$150–$250" },
      { label: "Larger / steep roof", value: "Quoted on-site" },
      { label: "Heavy debris (overdue)", value: "+$25–$50" },
    ],
  },
  serviceArea: {
    heading: "Gutter cleaning in East Brainerd and southeast Chattanooga.",
    body: [
      "We're on the road most weeks in East Brainerd, along East Brainerd Road, Standifer Gap, and out toward the Ooltewah and Collegedale line, plus neighboring East Ridge and the rest of Hamilton County. The drive stays short, so the visit price is the same as anywhere in the city.",
      "Booking a fall cleaning? Get on the list in September. From late October through Thanksgiving we book up tight as the hardwoods drop.",
    ],
  },
  faq: [
    {
